...
class MealPlanAllMealsPage extends StatefulWidget {
  const MealPlanAllMealsPage({super.key, required this.mytitle});
  final String mytitle;
  static final MealPlanController _myController = MealPlanController();
  @override
  // ignore: library_private_types_in_public_api
  _MealPlanAllMealPage createState() => _MealPlanAllMealPage();
}

class _MealPlanAllMealPage extends State<MealPlanAllMealsPage> {
  void _refreshMeals() {
    setState(() {});
  }
  @override
